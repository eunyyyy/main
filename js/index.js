{
    ...
    class Menu {
        ...
        render() {
            ...
            this.lastMousePos.translation.x = lerp(this.lastMousePos.translation.x, this.mousePos.x, 0.2); /*0.2*/
            this.lastMousePos.translation.y = lerp(this.lastMousePos.translation.y, this.mousePos.y, 0.2); /*0.2*/
            ...
            this.lastMousePos.displacement.x = lerp(this.lastMousePos.displacement.x, this.mousePos.x, 0.1); /* 0.1*/
            this.lastMousePos.displacement.y = lerp(this.lastMousePos.displacement.y, this.mousePos.y, 0.1); /* 0.1*/
            ...
            // 이미지 나타나는 효과의 위치 값 조정
            this.dmScale = Math.min(lineEq(50, 0, 140, 0, mouseDistance), -150);   
